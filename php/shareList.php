...
if ($userRes && mysqli_num_rows($userRes) > 0) {
    ...
    if (mysqli_num_rows($checkRes) > 0) {
        ...
        $insert = "INSERT INTO shared_lists (list_id, shared_with_user_id, permission) VALUES ('$list_id', '$sharedUserId', '$permission')";
        if (mysqli_query($conn, $insert)) {
            echo "List shared successfully with $permission permission.";
        } else {
